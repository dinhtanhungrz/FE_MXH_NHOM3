...
<div class="flex items-center justify-between">
  <div class="flex items-center space-x-3">
    <a href="${profileLink}" class="block hover:opacity-80 transition">
      <img src="${avatar}" alt="${u.username}" class="w-10 h-10 rounded-full object-cover border border-gray-100" />
    </a>
    <div>
...
// Đặt trên cùng, trong HomePage hoặc global của file
    ...
    <div class="lg:col-span-2 space-y-6">
      <div class="bg-white rounded-2xl shadow-lg p-6">
        <div class="flex space-x-3">
          <img src="${userAvatarUrl}" alt="${user?.username}" class="w-12 h-12 rounded-full object-cover" />
          <button id="openCreatePostBtn"
        ...
        <div class="flex justify-around mt-4 pt-4 border-t border-gray-200">
          <button id="videoLiveBtn"
            class="flex items-center space-x-2 text-gray-600 hover:bg-gray-100 px-4 py-2 rounded-lg transition">
      ...
      <div class="bg-white rounded-2xl shadow-lg p-6">
        ...
        <div class="space-y-4">
          <div class="flex items-start space-x-3">
            <img src="https://ui-avatars.com/api/?name=CodeGym&background=6366f1&color=fff"
  ...
  <div class="bg-white w-full max-w-lg rounded-2xl shadow-2xl animate-fadeIn">
    ...
    <div class="px-6 py-4">
      <div class="flex items-center space-x-3 mb-4">
        <img src="${avatarUrl}" class="w-12 h-12 rounded-full" />
        <div>
      ...
      <textarea id="postContent" rows="3" placeholder="Bạn đang nghĩ gì?"
        class="w-full resize-none text-lg outline-none placeholder-gray-400 break-words whitespace-pre-wrap overflow-hidden"></textarea>
