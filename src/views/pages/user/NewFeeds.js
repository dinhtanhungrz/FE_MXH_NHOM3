...
import GuestHome from "../guest/GuestHomePage.js";
/**
* New Feeds Page
*/
            ...
            <div class="grid md:grid-cols-2 gap-12 items-center">
                ...
                <div>
                    ...
                    <div class="mt-8 flex flex-col sm:flex-row gap-4">
                        ...
                        <a href="#/guest" 
                            class="px-4 py-2 border border-gray-300 text-gray-700 rounded-lg font-semibold hover:bg-gray-100 transition text-center">
                            Dùng thử ngay
                        </a>
                    </div>
                </div>
                ...
                <div class="relative">
                    <div class="relative z-10">
                        <img src="https://images.unsplash.com/photo-1522071820081-009f0129c71c?w=800&h=600&fit=crop"
                            alt="People connecting" class="rounded-2xl shadow-2xl" />
                    </div>
                    <div class="absolute -bottom-6 -right-6 w-72 h-72 bg-purple-200 rounded-full blur-3xl opacity-50">
                    </div>
